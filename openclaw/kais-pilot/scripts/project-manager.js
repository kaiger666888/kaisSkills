#!/usr/bin/env node
// kais-pilot project manager — bootstrap repos, manage git worktrees, checkpoint/resume
// Usage:
...
`;
  ...
  // Initial commit
  run('git add -A', root);
  run('git commit -m "init: project bootstrap by kais-pilot"', root) ||
